...
class Eigenmode2DLF4():
   ...
   def __init__(self, N, degree, dt, explicit=True, output=True):
      ...
      self.elastic.log("P-wave velocity: %f" % Vp(self.elastic.mu, self.elastic.l, self.elastic.density))
      self.elastic.log("S-wave velocity: %f" % Vs(self.elastic.mu, self.elastic.density))
